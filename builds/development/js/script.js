...
jQuery(document).ready(function(){
    jQuery('#inbox').load('../images/nav/inbox.svg');
    jQuery('#notification').load('../images/nav/notification.svg');
    jQuery('#search').load('../images/nav/search.svg');
    jQuery('#transactions').load('../images/nav/transactions.svg');
